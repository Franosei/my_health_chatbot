...
PRIVACY_NOTICE_POINTS = [
    "We store your account profile, role, consent records, password hash, conversation history, uploads, symptom logs, condition history, medication list, allergy and vitals entries, triage summaries, traces, and audit events so your account can persist across sessions.",
